...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <img class="animation__shake" src="img/GrisaSip.png" alt="AdminLTELogo" height="60" width="60">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="#" class="brand-link">
                <img src="/img/grisasip.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
                    style="opacity: .8">
                ...
                @auth
                   ...
                   with font-awesome or any other icon font library -->
                            ...
                            @if (Auth::user()->is_superadmin == 1)
                                <li class="nav-item {{ Request::is('data-master*') ? 'menu-open' : '' }}">
                                    ...
                                    <ul class="nav nav-treeview">
                                        <li
                                            class="nav-item {{ Request::is('data-master/kode-surat', 'data-master/kategori-kode', 'data-master/kode-surat/*/edit', 'data-master/kategori-kode/*/edit') ? 'menu-open' : '' }}">
                                            ...
                                            <ul class="nav nav-treeview">
                                                <li class="nav-item">
                                                    <a href="/data-master/kode-surat/"
                                                        class="nav-link {{ Request::is('data-master/kode-surat', 'data-master/kode-surat/*/edit') ? 'active' : '' }}">
                                                        <i class="far fa-dot-circle nav-icon"></i>
                                                        <p>Kode Surat</p>
                                                    </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a href="/data-master/kategori-kode/"
                                                        class="nav-link {{ Request::is('data-master/kategori-kode', 'data-master/kategori-kode/*/edit') ? 'active' : '' }}">
                                                        <i class="far fa-dot-circle nav-icon"></i>
                                                        <p>Kategori Kode</p>
                                                    </a>
                                                </li>
                                    ...
                                    <ul class="nav nav-treeview">
                                        <li
                                            class="nav-item {{ Request::is('data-master/kode-surat-masuk*') ? 'menu-open' : '' }}">
                                            <a href="#" class="nav-link">
                                                <i class="far fa-circle nav-icon"></i>
                                                <p>
                                                    Surat Masuk
                                            ...
                                            <ul class="nav nav-treeview">
                                                <li class="nav-item">
                                                    <a href="/data-master/kode-surat-masuk"
                                                        class="nav-link {{ Request::is('data-master/kode-surat-masuk', 'data-master/kode-surat-masuk/*/edit') ? 'active' : '' }}">
                                                        <i class="far fa-dot-circle nav-icon"></i>
                            ...
                            <li class="nav-item {{ Request::is('surat-masuk*', 'surat-keluar*') ? 'menu-open' : '' }}">
                                <a href="#"
                                    class="nav-link {{ Request::is('surat-masuk*', 'surat-keluar*') ? 'active' : '' }}">
                            ...
                            @if (Auth::user()->is_superadmin == 1)
                                <li class="nav-item">
                                    <a href="/admin"
                                        class="nav-link {{ Request::is('admin', 'admin/*/edit') ? 'active' : '' }}">
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; 2023-<?= date('Y') ?> <a target="_blank"
                    href="https://www.instagram.com/ridhoo_kurniawaan/">TIM IT GRISAWANGI</a>.</strong>
            All rights reserved.
    ...
    <script>
        ...
        function isBottom() {
            ...
            300; // 300 adalah jarak dari bawah halaman sebelum data tambahan dimuat
        }
            ...
            if (!isLoading) {
                ...
                $.ajax({
                    ...
                    error: function(xhr, status, error) {
                        console.error(error);
                        isLoading =
                        false; // Set isLoading kembali menjadi false jika terjadi kesalahan saat memuat data
                        $('#loader').hide(); // Sembunyikan loader
                    }
                });
            }
