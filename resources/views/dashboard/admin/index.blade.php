              ...
              <form action="/admin" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input name="name" autofocus required autocomplete="off" value="{{ old('name') }}" type="text" class="form-control @error('name') is-invalid @enderror" id="name" placeholder="Masukkan Nama">
                    @error('name')
                  ...
                  <div class="form-group">
                    ...
                    <img class="img-preview img-fluid pl-0 mb-3 col-sm-5">
                  ...
                  <div class="form-group">
                    ...
                    <select name="is_superadmin" required class="custom-select @error('is_superadmin') is-invalid @enderror">
                      ...
                      <option value="0" {{ old('is_superadmin') == '0' ? 'selected' : '' }}>Admin</option>
                      <option value="1" {{ old('is_superadmin') == '1' ? 'selected' : '' }}>Superadmin</option>
                    </select>
                    @error('is_superadmin')
                      <div class="invalid-feedback">
                        {{ $message }}
