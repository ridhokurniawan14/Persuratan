        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-warning">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form method="POST" action="/data-master/kategori-kode/{{ $kode_surat_keluars->id }}">
                @method('put')
                @csrf
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <select autofocus name="kode_surat_yplp" class="custom-select">
                      ...
                      @foreach ($categories as $category)
                        <option value="{{ $category->id }}" {{ old('kode_surat_yplp', $kode_surat_keluars->kode_surat_yplp) == $category->id ? 'selected' : '' }}>
                          {{ ucwords($category->kode) }}-{{ ucwords($category->ket) }}
                        </option>
                      @endforeach
                    </select>
                  ...
                  <div class="form-group">
                    ...
                    <input autocomplete="off" value="{{ old('nomor', $kode_surat_keluars->nomor) }}" required type="number" name="nomor" class="form-control @error('nomor') is-invalid @enderror" id="nomor" placeholder="Masukkan Nomor">
                    @error('nomor')
                      <div class="invalid-feedback">
                        {{ $message }}
                      </div>
                  ...
                  <div class="form-group">
                    ...
                    <input autocomplete="off" value="{{ old('ket', $kode_surat_keluars->ket) }}" required type="text" name="ket" class="form-control @error('ket') is-invalid @enderror" id="ket" placeholder="Masukkan Keterangan">
                    @error('ket')
                      <div class="invalid-feedback">
                        {{ $message }}
                      </div>
                ...
                <div class="card-footer">
                  ...
                  <a href="/data-master/kategori-kode/"><button type="button" class="btn btn-secondary">Kembali</button></a>
                </div>
              </form>
            </div>
            <!-- /.card -->
