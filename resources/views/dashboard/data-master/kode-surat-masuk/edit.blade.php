        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-warning">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form method="POST" action="/data-master/kode-surat-masuk/{{ $kode_surat_masuk->id }}">
                @method('put')
                @csrf
                <div class="card-body">
                  <div class="form-group">
                    <label for="kode">Kode</label>
                    <input autofocus autocomplete="off" value="{{ old('kode', strtoupper($kode_surat_masuk->kode)) }}" required type="text" name="kode" class="form-control @error('kode') is-invalid @enderror" id="kode" placeholder="Masukkan Kode">
                    @error('kode')
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" autocomplete="off" value="{{ old('ket', $kode_surat_masuk->ket) }}" required name="ket" class="form-control @error('ket') is-invalid @enderror"" id="ket" placeholder="Masukkan Keterangan">
                    @error('ket')
                      <div class="invalid-feedback">
                        {{ $message }}
                      </div>
                ...
                <div class="card-footer">
                  ...
                  <a href="/data-master/kode-surat-masuk/"><button type="button" class="btn btn-secondary">Kembali</button></a>
                </div>
              </form>
            </div>
            <!-- /.card -->
